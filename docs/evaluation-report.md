...
Latest AI follow-up: the [23 September complete-document study](https://github.com/Chi944/fieldops/blob/main/docs/release-study-2026-09-23.md) is separate from this unchanged offline baseline. A new live fact contract returned 0/3 complete quotations and 6/129 correct critical fields. A narrow decoder fix, replayed on the same saved responses without new model calls, retained two partial quotations and 34/129 critical fields; complete extraction remains 0/3. All eight retained prices stay blocked by review issues. No held-out model calls or production AI enablement occurred. These are post-hoc development results, not general accuracy claims.
